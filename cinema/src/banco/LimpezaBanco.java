...
public class LimpezaBanco {
    ...
    // [TRATAMENTO DE ERROS]: 'throws Exception' propaga o erro para a camada Controller.
    public void iniciarLimpeza(int salaId) throws Exception {
        // [CÓDIGO DE ACESSO AO BANCO DE DADOS]: Insert simples.
    ...
    public ResultSet historicoLimpeza(int salaId) throws Exception {
        ...
        PreparedStatement stmt = conn.prepareStatement(sql);
        stmt.setInt(1, salaId);
        // Retorna o ResultSet aberto para a camada de visualização (Controller) processar.
